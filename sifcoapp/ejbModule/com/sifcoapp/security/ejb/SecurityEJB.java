...
public class SecurityEJB implements SecurityEJBRemote {
	...
	public UserAppOutTO UserValidate(UserAppInTO usr) {
		...
		/*
		 * if
		 * (usr.getIdUserApp().equals("admin")&&usr.getPasswordUserApp().equals
		 * ("adminadmin")) usrValid.setValidUser(Common.VALID); else
	...
	public ProfileOutTO GetUserProfile(ProfileInTO usrProfile) {
		...
		profileDetL12
				.setUrl_perfil_det("/faces/view/mtto/ArticleInventoryMaster.xhtml");
