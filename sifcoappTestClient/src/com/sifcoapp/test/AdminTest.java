...
public class AdminTest {
	...
	public static void main(String[] args) {
		...
		// testPeriods();
			...
			AdminTest.articles_mtto();
		
			System.out
			.println("BankTest.check_mtto();-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------");
			AdminTest.articlesprices();
			
			System.out
			.println("BankTest.check_mtto();-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------");
			AdminTest.brach_mtto();
			
			System.out
			.println("BankTest.check_mtto();-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------");
			AdminTest.cat_tab1_catalogos_mtto();
			
			System.out
			.println("BankTest.check_mtto();-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------");
			AdminTest.findCatalog();
			
			System.out
			.println("BankTest.check_mtto();-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------");
			AdminTest.findCatalogByKey();
			
			System.out
			.println("BankTest.check_mtto();-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------");
			AdminTest.findCatalogQS();
			
			System.out
			.println("BankTest.check_mtto();-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------");
			AdminTest.getArticles();
			
			System.out
			.println("BankTest.check_mtto();-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------");
			AdminTest.getArticlesByKey();
			...
			System.out
			.println("BankTest.check_mtto();-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------");
			AdminTest.getEnterpriseInfo();
			
			System.out
			.println("BankTest.check_mtto();-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------");
			AdminTest.getPricesList();
			
			System.out
			.println("BankTest.check_mtto();-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------");
			AdminTest.getTablesCatalogTest();
			
			System.out
			.println("BankTest.check_mtto();-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------");
			AdminTest.ListStatus();
			
			System.out
			.println("BankTest.check_mtto();-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------");
			AdminTest.pricesList_mtto();
			
			System.out
			.println("BankTest.check_mtto();-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------");
			AdminTest.saveEnterprise();
