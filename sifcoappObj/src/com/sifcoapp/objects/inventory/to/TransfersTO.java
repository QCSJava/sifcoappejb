...
public class TransfersTO extends CommonTO {

	/**
	 * 
	 */
	private static final long serialVersionUID = 3964671561107088275L;
	/**
	 * 
	 */
	...
	public TransfersTO(int docentry, int docnum, String doctype,
			...
			Date createdate, int createtime, List transfersDetail) {
		super();
		...
		TransfersDetail = transfersDetail;
	}
	...
	public List getTransfersDetail() {
		return TransfersDetail;
	}

	public void setTransfersDetail(List transfersDetail) {
		TransfersDetail = transfersDetail;
	}
