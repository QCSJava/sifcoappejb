...
public class AccassignmentTO extends CommonTO {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -7741484109045924189L;
	...
	public AccassignmentTO() {
		super();
		// TODO Auto-generated constructor stub
	}

	public AccassignmentTO(int absentry, String periodcat, Date financyear,
			int year, String periodname, String subtype, int periodnum,
			Date f_refdate, Date t_refdate, Date f_duedate, Date t_duedate,
			Date f_taxdate, Date t_taxdate, String linkact_1, String linkact_2,
			String linkact_3, String linkact_4, String linkact_5,
			String linkact_6, String linkact_8, String linkact_9,
			String linkact_10, String linkact_11, String linkact_12,
			String linkact_13, String linkact_14, String linkact_15,
			String linkact_16, String linkact_17, String linkact_18,
			String dfltincom, String exmptincom, String dfltexpn,
			String forgnincm, String ecincome, String forgnexpn,
			String dfltratedi, String decresglac, String linkact_27,
			String dftstockob, String linkact_19, String linkact_20,
			String linkact_21, String linkact_22, String linkact_23,
			String linkact_24, String linkact_25, String linkact_26,
			String incresglac, String rturnngact, String cogm_act,
			String aloccstact, String variancact, String pricdifact,
			String cdownpymnt, String vdownpymnt, String cboercvble,
			String cboeonclct, String cboepresnt, String cboediscnt,
			String cunpaidboe, String vboepayble, String vasstboepy,
			String copendebts, String vopendebts, String purchseact,
			String pareturnac, String paoffsetac, String linkact_28,
			String exdiffact, String balanceact, String bnkchgact,
			String linkact_29, String linkact_30, String incmacct,
			String expnacct, String vatrevact, String expclract,
			String expofstact, String costrevact, String repomoact,
			String wipvaracct, String salevatoff, String purcvatoff,
			String dpmsalact, String dpmpuract, String expvaract,
			String costoffact, String ecexepnses, String stockact,
			String dflinprcss, String dfltincstm, String dfltprofit,
			String dfltloss, String vassets, String stockrvact,
			String stkrvofact, String wipacct, String dfltcard,
			String shpdgdsact, String glrvoffact, String overpayap,
			String undrpayap, String overpayar, String undrpayar,
			String arcmact, String arcmexpact, String arcmfrnact,
			String arcmeuact, String apcmact, String apcmfrnact,
			String apcmeuact, String negstckact, String stkintnact,
			String glgainxdif, String gllossxdif, String amountdiff,
			String slfinvincm, String slfinvexpn, String onholdact,
			String plaact, String icclract, String occlract, String purbalact,
			String whicenact, String whocenact, String saldpmint,
