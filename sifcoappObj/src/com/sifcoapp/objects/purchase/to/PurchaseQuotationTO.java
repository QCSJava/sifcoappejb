...
public class PurchaseQuotationTO extends CommonTO{
	/**
	 * 
	 */
	private static final long serialVersionUID = -1946395588085775641L;
	/**
	 * 
	 */
	...
	List purchaseQuotationDetails;
	public PurchaseQuotationTO() {
		super();
		// TODO Auto-generated constructor stub
	}
	public PurchaseQuotationTO(int docentry, int docnum, String doctype,
			String canceled, String docstatus, String objtype, Date docdate,
			Date docduedate, String cardcode, String numatcard,
			String cardname, Double vatsum, Double discsum, Double doctotal,
			String ref1, String ref2, String comments, String jrnlmemo,
			Date paidtodate, int transid, int receiptnum, int groupnum,
			String confirmed, String createtran, int series, Date taxdate,
			String filler, Double rounddif, String rounding, Date canceldate,
			String peymethod, String ctlaccount, String bplname,
			String vatregnum, Double paidsum, String towhscode, Double nret,
			String namenp, int quedan, Date fechreciva, Date fquedan,
	...
	public List getPurchaseQuotationDetails() {
		return purchaseQuotationDetails;
	}
	public void setPurchaseQuotationDetails(List purchaseQuotationDetails) {
		this.purchaseQuotationDetails = purchaseQuotationDetails;
	}
