...
public class PurchaseQuotationInTO extends CommonTO{
	/**
	 * 
	 */
	private static final long serialVersionUID = 9043315004978084082L;
	...
	public PurchaseQuotationInTO() {
		super();
		// TODO Auto-generated constructor stub
	}

	public PurchaseQuotationInTO(int docentry, int docnum, String doctype, String canceled,
			...
			int quedan, Date fechreciva, Date fquedan) {
		super();
