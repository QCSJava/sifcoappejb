...
public class PurchaseQuotationDetailTO extends CommonTO{
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -2095081069827874925L;
	/**
	 * 
	 */
	...
	public PurchaseQuotationDetailTO() {
		super();
		// TODO Auto-generated constructor stub
	}

	public PurchaseQuotationDetailTO(int docentry, int linenum, int targettype,
