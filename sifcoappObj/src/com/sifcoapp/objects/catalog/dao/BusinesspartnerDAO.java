...
public class BusinesspartnerDAO extends CommonDAO {
	...
	// ####################################
	public int inv_cat_bpa_businesspartner_mtto(BusinesspartnerTO parameters,
		...
		this.setDouble(20, "_creditline ",
				new Double(parameters.getCreditline()));
		...
		this.setDouble(28, "_orderbalsy ",
				new Double(parameters.getOrderbalsy()));
		...
		this.setDouble(33, "_balancesys ",
				new Double(parameters.getBalancesys()));
	...
	public int inv_cat_bpa_businesspartnerAcount_mtto(
	...
	public BusinesspartnerAcountTO get_businesspartnerAcountByKey(
		...
		List lstResultSet = null;
		this.setTypeReturn(Common.TYPERETURN_CURSOR);
		this.setDbObject("{call sp_get_businesspartneracount_by_key(?,?,?)}");
		this.setString(1, "_acctcode", parameters.getAcctcode());
		this.setString(2, "_acctype", parameters.getAcctype());
