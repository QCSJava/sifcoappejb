...
public class SalesTO extends CommonTO{
	/**
	 * 
	 */
	private static final long serialVersionUID = -1066954675233765237L;
	...
	public SalesTO(int docentry, int docnum, String doctype, String canceled,
			...
			Date createdate, int createtime, List salesDetails) {
		super();
	...
	public void setSalesDetails(List salesDetails) {
		this.salesDetails = salesDetails;
	}
