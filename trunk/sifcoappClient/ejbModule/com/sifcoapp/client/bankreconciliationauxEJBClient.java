...
import com.sifcoapp.admin.ejb.ParameterEJBRemote;
import com.sifcoapp.bussinessLogic.bankreconciliationauxEJBRemote;
import com.sifcoapp.clientutility.ClientUtility;

public class bankreconciliationauxEJBClient {
	private static final String LOOKUP_STRING = "java:global/sifcoappEAR/sifcoapp/bankreconciliationauxEJB!com.sifcoapp.admin.ejb.bankreconciliationauxEJBRemote";
	private static bankreconciliationauxEJBRemote bean;
	private static Context context = null;

	public bankreconciliationauxEJBClient() {

		try {
			context = ClientUtility.getInitialContext();
			bean = (bankreconciliationauxEJBRemote) context.lookup(LOOKUP_STRING);
	...
	public List getBankreconciliationaux(bankreconciliationauxInTO parameters)throws EJBException{
		...
		parameter = bean.getBankreconciliationaux(parameters);
