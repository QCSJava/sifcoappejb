 ...
 * 
 */
public class TransfersDetailTO extends CommonTO {

	/**
	 * 
	 */
	private static final long serialVersionUID = -1933394182573393406L;
	...
	public TransfersDetailTO(int docentry, int linenum, int targettype,
