...
public class bankreconciliationauxTO extends CommonTO {

	/**
	 * 
	 */
	private static final long serialVersionUID = 8074773511780125185L;

	public bankreconciliationauxTO() {
		super();
	...
	public bankreconciliationauxTO(int transid, int batchnum, String btfstatus,
			String transtype, String baseref, Date refdate, int intrnmatch,
			int extrmatch, String memo, String ref1, String ref2,
			Double loctotal, Double systotal, String transcode,
			Double transrate, int btfline, Date duedate, Date taxdate,
			int finncpriod, String refndrprt, String objtype, String indicator,
			String adjtran, Date stornodate, int stornototr, String autostorno,
			Date vatdate, int series, int number, String autovat,
			int docseries, String printed, String doctype, String creator,
			int seqcode, int serial, String autowt, Double wtapplied,
			Double baseamnt, Double basevtat, int basetrans, String ref3,
			String deferedtax, int agrno, int seqnum, String rptperiod,
			int usersign) {
		super();
