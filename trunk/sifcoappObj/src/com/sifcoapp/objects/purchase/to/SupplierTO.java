...
public class SupplierTO extends CommonTO{
	/**
	 * 
	 */
	private static final long serialVersionUID = -7360424568622601868L;
	/**
	 * 
	 */
	...
	public SupplierTO(int docentry, int docnum, String doctype, String canceled,
			...
			Date createdate, int createtime, List supplierDetails) {
		super();
	...
	public List getsupplierDetails() {
		return supplierDetails;
	}

	public void setsupplierDetails(List supplierDetails) {
		this.supplierDetails = supplierDetails;
	}
