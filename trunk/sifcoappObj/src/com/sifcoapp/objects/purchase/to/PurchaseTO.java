...
public class PurchaseTO extends CommonTO{
	/**
	 * 
	 */
	private static final long serialVersionUID = 5393691729467467095L;
	/**
	 * 
	 */
	...
	public PurchaseTO(int docentry, int docnum, String doctype, String canceled,
			...
			Date createdate, int createtime, List purchaseDetails) {
		super();
	...
	public void setpurchaseDetails(List purchaseDetails) {
		this.purchaseDetails = purchaseDetails;
	}
