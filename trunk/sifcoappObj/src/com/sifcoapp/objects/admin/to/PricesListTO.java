...
public class PricesListTO extends CommonTO {
	...
	public PricesListTO(int listnum, String listname, int base_num,
			Double factor, int roundsys, int groupcode, String isgrossprc,
			String validfor, String roundrule, String rndfrmtint,
			String rndfrmtdec, int usersign, List articlesPrices) {
		super();
	...
	public List getArticlesPrices() {
		return articlesPrices;
	}

	public void setArticlesPrices(List articlesPrices) {
		this.articlesPrices = articlesPrices;
	}
